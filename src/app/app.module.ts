...
@NgModule({
  ...
  imports: [
    ...
    HttpClientModule,
    MatFormFieldModule,
    MatInputModule, // materials  de mat input du form 
    FormsModule,
    ReactiveFormsModule,//trvailler avec les formulaire 
    MatIconModule , // importation des icons 
   MatDialogModule , // importation du dialog
   MatSidenavModule,
   MatToolbarModule,
   MatListModule,
   MatMenuModule,
